...
use Illuminate\Queue\InteractsWithQueue;      // Service WA kita
use Illuminate\Queue\SerializesModels; // Pembuat PDF
use Illuminate\Support\Facades\Log; // Penyimpanan file
use Illuminate\Support\Facades\Storage; // Untuk mencatat error
