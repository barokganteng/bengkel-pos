        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Grafik Pendapatan (Segera Hadir)</h6>
                </div>
                <div class="card-body">
                    <p>Nantinya di sini bisa diisi dengan grafik pendapatan mingguan atau bulanan.</p>
                </div>
            </div>
        </div>
    </div>
